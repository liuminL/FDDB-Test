...
int main(int argc, char *argv[]){
  ...
  string detFile = "F:/scratch/Data/detectionResults/FDDB/results.txt";
  ...
  string detFile = "/Users/vidit/scratch/Data/detectionResults/FDDB/results.txt";
